#include "sekCDriver.h"
UNICODE_STRING
	uStrDriverName = {36, 38, L"\\Device\\" SEKCDRVR },
	uStrDosDeviceName = {44, 46, L"\\DosDevices\\" SEKCDRVR };
...
NTSTATUS DriverEntry(IN PDRIVER_OBJECT theDriverObject, IN PUNICODE_STRING theRegistryPath)
{
	...
	if(KiwiOsIndex = getWindowsVersion())
	{
...
KIWI_OS_INDEX getWindowsVersion()
{
