...
{
	sekcee_stdout(L"%*s" L"**KEY (capi)**\n", level << 1, L"");
	if(capiKey)
	{
		sekcee_stdout(L"%*s" L"  dwVersion          : %08x - %u\n", level << 1, L"", capiKey->dwVersion, capiKey->dwVersion);
		sekcee_stdout(L"%*s" L"  dwUniqueNameLen    : %08x - %u\n", level << 1, L"", capiKey->dwNameLen, capiKey->dwNameLen);
		sekcee_stdout(L"%*s" L"  dwSiPublicKeyLen   : %08x - %u\n", level << 1, L"", capiKey->dwSiPublicKeyLen, capiKey->dwSiPublicKeyLen);
		sekcee_stdout(L"%*s" L"  dwSiPrivateKeyLen  : %08x - %u\n", level << 1, L"", capiKey->dwSiPrivateKeyLen, capiKey->dwSiPrivateKeyLen);
		sekcee_stdout(L"%*s" L"  dwExPublicKeyLen   : %08x - %u\n", level << 1, L"", capiKey->dwExPublicKeyLen, capiKey->dwExPublicKeyLen);
		sekcee_stdout(L"%*s" L"  dwExPrivateKeyLen  : %08x - %u\n", level << 1, L"", capiKey->dwExPrivateKeyLen, capiKey->dwExPrivateKeyLen);
		sekcee_stdout(L"%*s" L"  dwHashLen          : %08x - %u\n", level << 1, L"", capiKey->dwHashLen, capiKey->dwHashLen);
		sekcee_stdout(L"%*s" L"  dwSiExportFlagLen  : %08x - %u\n", level << 1, L"", capiKey->dwSiExportFlagLen, capiKey->dwSiExportFlagLen);
		sekcee_stdout(L"%*s" L"  dwExExportFlagLen  : %08x - %u\n", level << 1, L"", capiKey->dwExExportFlagLen, capiKey->dwExExportFlagLen);


		sekcee_stdout(L"%*s" L"  pUniqueName        : ", level << 1, L""); sekcee_stdout(L"%S\n", capiKey->pName);
		sekcee_stdout(L"%*s" L"  pHash              : ", level << 1, L""); kull_m_string_wprintf_hex(capiKey->pHash, capiKey->dwHashLen, 0); sekcee_stdout(L"\n");
		sekcee_stdout(L"%*s" L"  pSiPublicKey       : ", level << 1, L""); kull_m_string_wprintf_hex(capiKey->pSiPublicKey, capiKey->dwSiPublicKeyLen, 0); sekcee_stdout(L"\n");
		sekcee_stdout(L"%*s" L"  pSiPrivateKey      :\n", level << 1, L"");
		...
		sekcee_stdout(L"%*s" L"  pSiExportFlag      :\n", level << 1, L"");
		...
		sekcee_stdout(L"%*s" L"  pExPublicKey       : ", level << 1, L""); kull_m_string_wprintf_hex(capiKey->pExPublicKey, capiKey->dwExPublicKeyLen, 0); sekcee_stdout(L"\n");
		sekcee_stdout(L"%*s" L"  pExPrivateKey      :\n", level << 1, L"");
		...
		sekcee_stdout(L"%*s" L"  pExExportFlag      :\n", level << 1, L"");
...
{
	sekcee_stdout(L"%*s" L"**KEY (cng)**\n", level << 1, L"");
	if(cngKey)
	{
		sekcee_stdout(L"%*s" L"  dwVersion             : %08x - %u\n", level << 1, L"", cngKey->dwVersion, cngKey->dwVersion);
		sekcee_stdout(L"%*s" L"  unk                   : %08x - %u\n", level << 1, L"", cngKey->unk, cngKey->unk);
		sekcee_stdout(L"%*s" L"  dwNameLen             : %08x - %u\n", level << 1, L"", cngKey->dwNameLen, cngKey->dwNameLen);
		sekcee_stdout(L"%*s" L"  type                  : %08x - %u\n", level << 1, L"", cngKey->type, cngKey->type);
		sekcee_stdout(L"%*s" L"  dwPublicPropertiesLen : %08x - %u\n", level << 1, L"", cngKey->dwPublicPropertiesLen, cngKey->dwPublicPropertiesLen);
		sekcee_stdout(L"%*s" L"  dwPrivatePropertiesLen: %08x - %u\n", level << 1, L"", cngKey->dwPrivatePropertiesLen, cngKey->dwPrivatePropertiesLen);
		sekcee_stdout(L"%*s" L"  dwPrivateKeyLen       : %08x - %u\n", level << 1, L"", cngKey->dwPrivateKeyLen, cngKey->dwPrivateKeyLen);
		sekcee_stdout(L"%*s" L"  unkArray[16]          : ", level << 1, L""); kull_m_string_wprintf_hex(cngKey->unkArray, sizeof(cngKey->unkArray), 0); sekcee_stdout(L"\n");
		sekcee_stdout(L"%*s" L"  pName                 : ", level << 1, L""); sekcee_stdout(L"%.*s\n", cngKey->dwNameLen / sizeof(wchar_t), cngKey->pName);
		sekcee_stdout(L"%*s" L"  pPublicProperties     : ", level << 1, L""); kull_m_key_cng_properties_descr(level + 1, cngKey->pPublicProperties, cngKey->cbPublicProperties);
		sekcee_stdout(L"%*s" L"  pPrivateProperties    :\n", level << 1, L"");
		...
		sekcee_stdout(L"%*s" L"  pPrivateKey           :\n", level << 1, L"");
