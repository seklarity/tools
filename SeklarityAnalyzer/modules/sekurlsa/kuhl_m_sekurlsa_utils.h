...
typedef struct _KIWI_MSV1_0_LIST_61_ANTI_SEKCEE {
	struct _KIWI_MSV1_0_LIST_61_ANTI_SEKCEE *Flink;
	struct _KIWI_MSV1_0_LIST_61_ANTI_SEKCEE *Blink;
	PVOID unk0;
	ULONG unk1;
	PVOID unk2;
	ULONG unk3;
	...
	ULONG unk22;
	PVOID CredentialManager;
} KIWI_MSV1_0_LIST_61_ANTI_SEKCEE, *PKIWI_MSV1_0_LIST_61_ANTI_SEKCEE;
